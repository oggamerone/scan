		...
		if (!$this->db->table_exists($this->db->dbprefix('preferences')))
		{
			...
			$this->db->query(
					"INSERT INTO `" . $this->db->dbprefix('preferences') . "` (`name`, `value`, `group`) VALUES
                                                ...
                                                ('fs_gen_footer_text', 'If you liked any of the manga you obtained here, consider buying the original versions, or the local translation, where available. Thanks for your support.', 0),
