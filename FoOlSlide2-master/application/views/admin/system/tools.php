...
<div class="table">
	...
	<?php if ($database_backup): ?>
		<div style="margin:0 10px 15px 0;">
			...
			<span><a href="<?php echo site_url('admin/system/tools_database_backup') ?>" class="btn"><?php echo _('Download Database Backup'); ?></a></span>
		</div>
	<?php endif; ?>
	...
	<div style="margin:0 10px 15px 0;">
		...
		<span><a href="#" class="btn" data-toggle="modal" data-target="#modal-for-log-display"  onClick="return getLog();"><?php echo _('View Logs'); ?></a></span>
		<span style=""><?php
	$CI = & get_instance();
	$CI->buttoner[] = array(
		'text' => _('Prune Logs'),
	...
	?></span>
        ...
        <div id="modal-for-log-display" class="modal fade" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h3 id="modal-text-head"><?php echo _('View Logs'); ?></h3>
                    </div>
                    <div class="modal-body">
                        ...
                        <select class="form-control" id="modal-select-log" style="display:none; margin-bottom:10px;" onchange="getLog(this.value)"></select>
                        <textarea class="form-control" id="log-display-output" style="min-height: 300px; width: 100%; font-family: Consolas,Monaco,Lucida Console,Liberation Mono,DejaVu Sans Mono,Bitstream Vera Sans Mono,Courier New, monospace !important" readonly="readonly">
                        </textarea>
                    ...
                    <div class="modal-footer">
                        ...
                        {
                            echo '<center><a class="btn btn-primary" style="float: none" href="#" onclick="return pastebinLog()">' . _('Pastebin It!') . '</a></center>';
                        }
                        ?>
                    </div>
                </div>
	...
	<div style="margin:0 10px 15px 0;">
		...
		<span>
			<a href="#" class="btn btn-success" data-toggle="modal" data-target="#modal-for-library-check" onClick="checkLibrary(true)"><?php echo _('Check library'); ?></a>
			<a href="#" class="btn btn-danger" rel="popover-right" data-original-title="Repair library" data-content="<?php echo htmlentities(_('This is actually a dangerous operation. Always perform a check and make sure you have a backup of your data.')) ?>" data-toggle="modal" data-target="#modal-for-library-check" onClick="checkLibrary(true, true)"><?php echo _('Repair library'); ?></a>
		</span>
           
        <div id="modal-for-library-check" class="modal fade" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    ...
                    <div class="modal-body" style="text-align: center">
                        ...
                        <textarea class="form-control" id="check-display-output" style="min-height: 300px; font-family: Consolas,Monaco,Lucida Console,Liberation Mono,DejaVu Sans Mono,Bitstream Vera Sans Mono,Courier New, monospace !important" readonly="readonly"></textarea>
                    ...
                    <div class="modal-footer">
                        ...
                        if (function_exists('curl_init'))
                        {
                            echo '<center><a class="btn btn-primary" style="float: none" href="#" onclick="return pastebinCheck()">' . _('Pastebin It!') . '</a></center>';
                        }
                        ?>
                    </div>
                </div>
